...
pipeline {
    ...
    stages {
            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'DockerHub-Credential', toolName: 'docker') {
                        sh "docker build -t DockerBenard/shippingservice:latest ."
                    }
                }
            }
        }
        ...
        stage('Snyk SCA Test | Dependencies') {
            steps {
                sh "${SNYK_HOME}/snyk-linux test --docker DockerBenard/shippingservice:latest || true" 
            }
        }
        ...
        //         script {
        //             withDockerRegistry(credentialsId: 'DockerHub-Credential', toolName: 'docker') {
        //                 sh "docker push DockerBenard/shippingservice:latest "
        //             }
        //         }
        //     }
        // }
    ...
    always {
        ...
        slackSend channel: '#ngwabern--multi-microservices-alerts', //update and provide your channel name
